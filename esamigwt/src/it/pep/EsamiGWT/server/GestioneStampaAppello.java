...
public class GestioneStampaAppello {
     ...
     */
    static private void addDatiElaboratoHTML(Appelli appello, Elaborati el, StringBuffer retVal, boolean primaVolta, String url, boolean anonimo) {
...
//        retVal.append(primaVolta ? "<hr>" : "<p STYLE=\"page-break-before: always\"><hr></p>");
        ...
        col1 = HtmlCodeForPrint.creaColonna("Elaborato n. " +
                HtmlCodeForPrint.creaBarcode("" + appello.getID() + "-" + el.getID(), url));
    ...
    static private void addDomandeHTML(Elaborati el, StringBuffer retVal, int numColonne) {
...
//        String colDom2 = null;
        for (DomandeElaborati de : listaDomandeElaborati) {
            ...
            numDomanda++;
            if ((numColonne == 1) || (numColonne == 2 && numDomanda % 2 == 1)) {   // devo creare le 2 colonne
                colDom1 = "";
//                colDom2 = "";
            }
//            col1 = HtmlCodeForPrint.creaColonna("" + de.getID());
            ...
            if (numColonne == 1) {
                ...
                if (numDomanda % 2 == 0 || numDomanda > totaleDomande) {   // devo appendere le 2 colonne
                    retVal.append(HtmlCodeForPrint.creaRiga(
                            HtmlCodeForPrint.creaColonna(HtmlCodeForPrint.creaTabellaEsami(colDom1)) +
                            HtmlCodeForPrint.creaColonna(HtmlCodeForPrint.creaTabellaEsami(tmpRetVal.toString()))));
                } else {
    ...
    static public String creaStampa(HttpSession httpSess, Appelli appello, String url, boolean stampaDomande, boolean stampaRisposte, boolean anonimo, int numColonne) {
...
//        String dataAppello = df.format(appello.getDataAppello());
    ...
    private static void stampaFoglioDomande(Appelli appello, Elaborati el, StringBuffer retVal, boolean primaVolta, String url, boolean anonimo, int numColonne) {
        ...
        retVal.append(HtmlCodeForPrint.getEndTable());
//        retVal.append("<p STYLE=\"page-break-after: always\"><hr></p>");
...
//        String jsp = url + "jsp/StampaRisposte.jsp";
